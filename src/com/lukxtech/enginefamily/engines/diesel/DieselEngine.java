package com.lukxtech.enginefamily.engines.diesel;
...
import com.lukxtech.enginefamily.engines.diesel.enums.CetaneNumber;
import com.lukxtech.enginefamily.engines.diesel.enums.ExhaustGasRecirculationState;
import com.lukxtech.enginefamily.engines.diesel.enums.FuelPumpType;
import com.lukxtech.enginefamily.engines.diesel.enums.TurbochargerType;
...
import com.lukxtech.enginefamily.engines.diesel.exceptions.InvalidGlowPlugCountException;
...
public class DieselEngine extends AbstractEngineModel implements InternalCombustionEngineInterface {
    ...
    public static class Builder extends AbstractEngineBuilder<DieselEngine, Builder>{
        ...
        public void validate(){
            ...
            if(glowPlugCount == null)   throw new InvalidGlowPlugCountException("ALERT! GLOW PLUG COUNT NOT SPECIFIED! NULL_EXCEPTION");
            if(isParticulateFilterPresent == null)  throw new InvalidParticulateFilterDataException("ALERT! PARTICULATE FILTER DATA NOT FOUND!");
            if(exhaustGasRecirculationState == null)    throw new InvalidExhaustGasRecirculationStateException("ALERT! GAS RECIRCULATION STATE NOT SPECIFIED! NULL_EXCEPTION");
        }
        @Override
