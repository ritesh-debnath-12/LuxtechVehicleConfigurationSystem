package com.lukxtech.powertrain.clutchfamily.clutches.platebased.multiplate;
...
public class MultiPlateClutch extends AbstractClutchModel implements ClutchInterface, PlateBasedClutchInterface {
    ...
    public static class Builder extends AbstractClutchBuilder<MultiPlateClutch, Builder> {
        private ActuationType actuationType;
        private CoolingType coolingType;
        ...
        @Override
        public MultiPlateClutch build() {
            validate();
            return new MultiPlateClutch(
                    modelNumber,
                    clutchType,
                    torqueCapacityNM,
