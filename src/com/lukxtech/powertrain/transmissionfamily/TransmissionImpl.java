package com.lukxtech.powertrain.transmissionfamily;

import com.lukxtech.powertrain.transmissionfamily.transmissions.amt.AutomatedManualTransmission;
import com.lukxtech.powertrain.transmissionfamily.transmissions.cvt.ContinuouslyVariableTransmission;
import com.lukxtech.powertrain.transmissionfamily.transmissions.dct.DualClutchTransmission;
import com.lukxtech.powertrain.transmissionfamily.transmissions.manual.ManualTransmission;
...
public class TransmissionImpl {
    public static void main(String[] args) {
        ...
        ManualTransmission manualTransmission = new ManualTransmission.Builder()
                .modelNumber("LUKX-TRANSMISSION-PF22")
